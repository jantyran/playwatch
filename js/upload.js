...
// 		let sp_selectors = document.getElementsByClassName('sp_selectors');
// 		for(let selector of selectors){
// 			selector.style.display='none';
// 		}
// 		for(let sp_selector of sp_selectors){
// 			sp_selector.style.display='none';
// 		}
// 		// selectors.style.display='none';
// 		// sp_selectors.style.display='none';
// 		// $('.selectors').attr('display', 'none');
// 		// $('.sp_electors').attr('display', 'none');
// 		let shift_selectors = document.getElementsByClassName('shift_selectors');
// 		let sp_shift_selectors = document.getElementsByClassName('sp_shift_selectors');
// 		shift_selectors[0].style.display='none';
// 		sp_shift_selectors[0].style.display='none';
// 		let bigger =document.getElementById('bigger');
// 		let sp_bigger =document.getElementById('sp_bigger');
// 		let smaller = document.getElementById('smaller');
// 		let sp_smaller = document.getElementById('sp_smaller');
// 		sp_bigger.style.display='none';
// 		sp_smaller.style.display='none';
// 		// next_comp
// 		let sp_next = document.getElementById('sp_next_complete');
...
completes[0].addEventListener('click', function(){
	this.style.visibility='hidden';
	var selectors = document.getElementsByClassName('selectors');
	var sp_selectors = document.getElementsByClassName('sp_selectors');
	for (var i = selectors.length - 1; i >= 0; i--) {
		selectors[i].style.display='none';
	}
	for (var i = sp_selectors.length - 1; i >= 0; i--) {
		sp_selectors[i].style.display='none';
	}
	// selectors.style.display='none';
	// sp_selectors.style.display='none';
	// $('.selectors').attr('display', 'none');
	// $('.sp_electors').attr('display', 'none');
	var shift_selectors = document.getElementsByClassName('shift_selectors');
	var sp_shift_selectors = document.getElementsByClassName('sp_shift_selectors');
	shift_selectors[0].style.display='none';
	sp_shift_selectors[0].style.display='none';
	var bigger =document.getElementById('bigger');
	var sp_bigger =document.getElementById('sp_bigger');
	var smaller = document.getElementById('smaller');
	var sp_smaller = document.getElementById('sp_smaller');
	sp_bigger.style.display='none';
	sp_smaller.style.display='none';
	// next_comp
	var sp_next = document.getElementById('sp_next_complete');
	sp_next.style.display='block';
	var next = document.getElementById('next_complete');
	next.style.display='block';
});

completes[1].addEventListener('click', function(){
	this.style.visibility='hidden';
	var selectors = document.getElementsByClassName('selectors');
	var sp_selectors = document.getElementsByClassName('sp_selectors');
	for (var i = selectors.length - 1; i >= 0; i--) {
...
// (function(doc){
//     var dom = doc.getElementById("sp_up_reset");
//     var button = doc.getElementById("sp_complete");
...
//                     "<em>I</em> like <span style='color:white; text-shadow:0 0 2px blue;'>cheese</span>"+dom.innerHTML +
//                 "</div>" +
//             "</foreignObject>" +
//         "</svg>";
//     var img = new Image();
...
// (function(doc){
//     var dom = doc.getElementById("sp_up_reset");
//     var button = doc.getElementById("complete");
//     var canvas = doc.getElementById("wolrd");
//     var ctx = canvas.getContext("2d");
//     ctx.canvas.width = dom.offsetWidth;
//     ctx.canvas.height = dom.offsetHeight;
//     //console.log(dom.offsetWidth, dom.style.width);
...
// (function(doc){
//     var dom = doc.getElementById("ddd");
